#
#  Be sure to run `pod spec lint VideoPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "hy_iMac" => "wwdc14@vip.qq.com" }
  # Or just: spec.author    = "hy_iMac"
  # spec.authors            = { "hy_iMac" => "wwdc14@vip.qq.com" }
  # spec.social_media_url   = "https://twitter.com/hy_iMac"
